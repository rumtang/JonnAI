  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="p-2.5 rounded-xl bg-black/60 backdrop-blur-xl border border-white/10 text-slate-300 hover:text-white mb-2 transition-all"
      >
      ...
      {controlsVisible && (
        <motion.div
          ...
          className="bg-black/70 backdrop-blur-2xl border border-white/10 rounded-xl p-4 w-64 shadow-2xl"
        >
            ...
            {nodeTypes.map(type => (
              <div key={type} className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  />
                  <span className="text-sm text-slate-300">{NODE_TYPE_LABELS[type]}</span>
                </div>
                <Switch
          ...
          <div className="border-t border-white/5 mt-4 pt-4 space-y-2">
            <Button
              ...
              className="w-full justify-start text-slate-400 hover:text-white text-xs"
            >
